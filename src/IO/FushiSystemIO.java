...
public class FushiSystemIO {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length != 1) {
			stdErr.println("Usage: java FushiSystemIO filename");
		} else {
			...
			FushiSystemIO app = new FushiSystemIO(testDatabase);
	...
	/**
	 * Constructs a <code>FushiSystemIO</code> object. Initialize the student catalog
	 * and the test database with the values specified in the parameters.
	 */
	public FushiSystemIO(TestDatabase initialTestDatabase) {
